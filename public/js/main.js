...
const routes = [
    { path: '', loadChildren: () => __webpack_require__.e(/*! import() | pages-colaboracoes-colaboracoes-module */ "pages-colaboracoes-colaboracoes-module").then(__webpack_require__.bind(null, /*! ./pages/colaboracoes/colaboracoes.module */ "./src/app/pages/colaboracoes/colaboracoes.module.ts")).then(m => m.ColaboracoesModule) },
];
...
class AppComponent {
    constructor() {
        this.title = 'angular-prototipo01';
    }
}
...
module.exports = __webpack_require__(/*! C:\Users\Fillipe\workspace\prototipo01\resources\angular-prototipo01\src\main.ts */"./src/main.ts");
